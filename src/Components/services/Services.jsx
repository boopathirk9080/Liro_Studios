    ...
    <section class="py-10 bg-white sm:py-16 lg:py-24">
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
          ...
          <p class="max-w-xl mx-auto mt-4 text-2xl leading-relaxed text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis.</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-10 mx-auto mt-12 lg:max-w-75rem lg:grid-cols-2 lg:gap-3rem justify-center">
          <div className="md:max-w-[840px] mx-auto">
            ...
            <div class="px-5 sm:px-0">
              <p class="mt-4 text-justify text-sm sm:text-4xl md:text-4xl lg:text-xl leading-relaxed text-gray-600 max-w-full sm:max-w-400  lg:max-w-2xl">
          ...
          <div className="md:max-w-[840px] mx-auto">
            ...
            <div class="px-5 sm:px-0">
              <p class="mt-4 text-justify text-sm sm:text-4xl md:text-4xl lg:text-xl leading-relaxed text-gray-600 max-w-full sm:max-w-400  lg:max-w-2xl">
                ...
                various platforms, enhancing your brand’s reach and impact. </p>
