        ...
        <section class="py-10 bg-gray-50 sm:py-16 lg:py-24">
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8" >
                <div class="grid items-stretch gap-y-10 md:grid-cols-2 md:gap-x-20">
                    <div class="relative grid grid-cols-2 gap-6" style={{ marginTop: "-50px" }}>
                        <div class="relative">
                            <img class="relative w-full xl:max-w-md "
                                style={{ height: '110%', width: '210%', marginLeft: "50px" }}
                                src="./digitalMarketing/animated1.gif" alt="" />
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col items-start xl:px-16">
                        <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl"><span class="highlights">DIGITAL MARKETING</span></h2>
                        <br></br>
                        <p class="mt-4 text-base leading-relaxed text-gray-600 text-justify" style={{ maxWidth: '450px' }}>Liro Studios helps businesses grow using digital marketing strategies. We use social media, search engines, and websites to reach customers. Our methods include SEO, content marketing, email campaigns, and targeted ads to improve online visibility and engage with customers. By analyzing data and adjusting strategies in real time, Liro Studios ensures businesses get the most out of their digital marketing efforts, helping them grow and succeed online.</p>
                    </div>
                </div>
            </div>
